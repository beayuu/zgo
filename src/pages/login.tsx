  ...
  return (
    <div className="min-h-screen flex w-full">
      ...
      <div className="hidden lg:flex w-1/2 relative bg-slate-900">
        <img 
          src="/waterfront-sunset.png" 
          alt="Zamboanga Sunset" 
          className="absolute inset-0 w-full h-full object-cover opacity-80"
        />
        <div className="absolute inset-0 bg-gradient-to-t from-slate-900/80 via-transparent to-transparent"></div>
        <div className="absolute bottom-12 left-12 right-12">
          <h2 className="text-4xl font-bold text-white mb-4">Your Zamboanga adventure starts here.</h2>
          <p className="text-lg text-slate-200">Sign in to access your bookings, saved favorites, and exclusive deals.</p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white">
        <div className="max-w-md w-full">
          ...
          <p className="text-slate-500 mb-8">Enter your details to sign in to your account</p>
          ...
          <form className="space-y-5" onSubmit={(e) => { e.preventDefault(); window.location.href = '/dashboard'; }}>
            ...
            <Button type="submit" size="lg" className="w-full h-12 text-base shadow-md">Sign In</Button>
          </form>
